...
import { UploadExperience } from "@/components/workflow-experiences";
...
export default function DataPage() {
  return (
    <MemberShell>
      ...
      <section className="data-summary-grid"><article className="paper-card data-summary"><span>OVERALL COVERAGE</span><strong>87%</strong><p>8 of 10 Twin domains supported</p><div className="summary-bar"><i /></div></article><article className="paper-card data-summary"><span>OBSERVATIONS</span><strong>18,420</strong><p>Across 5 connected sources</p><small>+842 this week</small></article><article className="paper-card data-summary"><span>FRESHNESS</span><strong>6 min</strong><p>Since latest wearable sync</p><small className="positive">All systems healthy</small></article></section>
