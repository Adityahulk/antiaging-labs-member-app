...
export default function ExperimentsPage(){return <MemberShell><PageHeader eyebrow="FOCUS OPTIONS" title="Choose one focus." /><DataGate title="Loading response test options…"><ExperimentsExperience/></DataGate></MemberShell>}
