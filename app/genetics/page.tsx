...
export default function GeneticsPage(){return <MemberShell><PageHeader eyebrow="GENETICS" title="Inherited context, without the black box." description="Inspect quality, supported calls, evidence versions, ambiguity, and every released interpretation."/><DataGate title="Loading inherited context…"><GeneticsExperience/></DataGate></MemberShell>;}
