...
export default function JourneyPage() { return <MemberShell><PageHeader eyebrow="TIMELINE" title="Timeline." /><DataGate lines={4} title="Loading your journey…"><JourneyExperience /></DataGate></MemberShell>; }
