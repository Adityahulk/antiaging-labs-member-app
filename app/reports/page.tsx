...
export default function ReportsPage() { return <MemberShell><PageHeader eyebrow="REPORTS" title="The complete story behind your data." description="Fast summaries and full analysis from the same immutable report version." /><ReportsExperience /></MemberShell>; }
