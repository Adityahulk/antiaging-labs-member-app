...
export default function TwinPage() { return <MemberShell><PageHeader eyebrow="TWIN" title="Your Twin." /><DataGate lines={4} title="Building your Twin view…"><TwinExperience /></DataGate></MemberShell>; }
